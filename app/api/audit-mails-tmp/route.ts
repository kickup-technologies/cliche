 ...
 *
 * Envía los 7 tipos de correo con datos de ejemplo a un destinatario fijo, para
 * revisar visualmente cómo se ven. Protegido por un secreto de un solo uso y con
 * destinatario FIJO (no se puede usar para spamear a terceros).
 */
const SECRET = "24df0a49a6812c725fe752977f1b2abd"
...
export async function GET(req: NextRequest) {
  ...
  // Productos reales → para que las miniaturas de los correos carguen de verdad.
  ...
  // 1. Código de seguridad admin (6 dígitos — así se ve el cambio nuevo)
  await run("1_codigo_seguridad", () => sendAdminOtpEmail(TO, "482913"))

  // 2. Bienvenida + código de descuento
  await run("2_bienvenida", () => sendWelcomeEmail(TO, "BIENVENIDA10"))

  // 3. Confirmación de compra (con desglose: subtotal, descuento, envío)
  ...
  // 4. Pedido enviado (con número de guía)
  ...
  // 7. Alerta de pedido nuevo al admin — normalmente va a ADMIN_EMAIL; para la
  //    auditoría lo redirigimos al destinatario fijo solo en esta invocación.
