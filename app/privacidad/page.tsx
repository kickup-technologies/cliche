          ...
          <div className="prose prose-sm max-w-none space-y-10 text-foreground">
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-1 mt-3">
                <li>Correo de contacto para datos: <strong>clichecomercioexterior@gmail.com</strong></li>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                Para ejercer cualquiera de estos derechos, envíe una solicitud a <strong>clichecomercioexterior@gmail.com</strong> con asunto "Derechos ARCO — Datos Personales" e incluya su nombre completo y correo electrónico registrado. Atenderemos su solicitud en un plazo máximo de <strong>15 días hábiles</strong>.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                El Sitio no está dirigido a menores de 18 años. No recopilamos conscientemente datos personales de menores. Si como padre, madre o tutor detecta que un menor nos ha proporcionado información, escríbanos a <strong>clichecomercioexterior@gmail.com</strong> para proceder a la eliminación inmediata de dichos datos.
              </p>
            </section>
