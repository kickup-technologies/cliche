...
export const CATALOG: CatalogProduct[] = [
  ...
  make(
    2, "Vientos de Lino", "vientos-de-lino", "jpeg",
  ...
  make(
    3, "Eternamente Índigo", "eternamente-indigo", "jpeg",
  ...
  make(
    4, "Sello de Dios", "sello-de-dios", "jpeg",
    "Pureza que serena",
  ...
  make(
    5, "Brillos de Seda", "brillos-de-seda", "jpeg",
  ...
  make(
    6, "Calor de Lana", "calor-de-lana", "jpeg",
  ...
  make(
    7, "Índigo Profundo", "indigo-profundo", "jpeg",
  ...
  make(
    11, "Best Friends", "best-friends", "jpeg",
  ...
  make(
    12, "Lycra de Verano", "lycra-de-verano", "jpeg",
  ...
  make(
    15, "Romeo y Julieta", "romeo-y-julieta", "jpeg",
  ...
  make(
    19, "Hilos de Seda", "hilos-de-seda", "jpeg",
